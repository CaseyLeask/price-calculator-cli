...
* The cart schema is available at: [/cart.schema.json](http://take-home-test.herokuapp.com/cart.schema.json). Some example carts are available at: [/cart-4560.json](http://take-home-test.herokuapp.com/cart-4560.json), [/cart-9363.json](http://take-home-test.herokuapp.com/cart-9363.json), [/cart-9500.json](http://take-home-test.herokuapp.com/cart-9500.json), and [/cart-11356.json](http://take-home-test.herokuapp.com/cart-11356.json).
* The base price schema is available at: [/base-prices.schema.json](http://take-home-test.herokuapp.com/base-prices.schema.json). An example of base prices is available at: [/base-prices.json](http://take-home-test.herokuapp.com/base-prices.json).
